# Clanker Ops #109: [BUTLER] Board hygiene — stale blockedBy, ghost assignees, orphan plans
...
- Confirm #109 is still open, assigned to you, and not blocked.
- Mark #109 in progress before implementation work.
...
Daily system check: scan for stale blockedBy, ghost assignees, orphan plan files. Report findings, don't fix them — that's the job, not the fix.
