# Clanker Ops #110: [BUTLER] Dupe comb — detect overlapping pending tasks
...
- Confirm #110 is still open, assigned to you, and not blocked.
- Mark #110 in progress before implementation work.
...
Run dupe detection: scan all pending tasks for ≥60% intent overlap, print compare N M output for review.
