# Clanker Ops #111: [BUTLER] Roster sync — verify assignees match CLANKER_ROSTER.md
...
- Confirm #111 is still open, assigned to you, and not blocked.
- Mark #111 in progress before implementation work.
...
Cross-reference all task assignees against CLANKER_ROSTER.md. Flag any assignments that don't match the expected role.
