# Clanker Ops #114: [BUTLER] Plan file cleanup — remove orphaned .md files
...
- Confirm #114 is still open, assigned to you, and not blocked.
- Mark #114 in progress before implementation work.
...
Scan `.pi/todo-plans/` for plan files whose task no longer exists. Report orphan paths for cleanup.
