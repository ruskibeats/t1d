# Clanker Ops #118: [GRAPH] Add lipid panel metrics (cholesterol, HDL, LDL, triglycerides) to MetricType enum

Status: completed
Owner: @worker
Tags: #graph, backend, data
Branch: dad_1805
...
- Confirm #118 is still open, assigned to you, and not blocked.
- Mark #118 in progress before implementation work.
...
Add lipid panel metrics identified as missing from gap analysis with HuggingFace diabetes dataset. Add CHOLESTEROL_TOTAL, HDL_CHOLESTEROL, LDL_CHOLESTERERIDE, TRIGLYCERIDES to MetricType enum in app/metrics/types.py. Update models/schemas as needed.
