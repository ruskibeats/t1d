# Clanker Ops #129: [SPRINT 12] Provider Showcase — integrate OpenRouter, OpenAI, Anthropic with fallback
...
- Confirm #129 is still open, assigned to you, and not blocked.
- Mark #129 in progress before implementation work.
...
### Intended Outcome
- Deliver the requested outcome for: [SPRINT 12] Provider Showcase — integrate OpenRouter, OpenAI, Anthropic with fallback.
...
Plan:
- Test OpenRouter models (already configured)
- Add OpenAI direct integration example
- Add Anthropic direct integration example
- Document fallback chains
- Add to docs/

Likely files: app/services/llm_service.py, docs/
