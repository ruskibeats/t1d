# Clanker Ops #130: [SPRINT 13] CI/CD Pipeline — GitHub Actions for test, lint, deploy
...
- Confirm #130 is still open, assigned to you, and not blocked.
- Mark #130 in progress before implementation work.
...
### Intended Outcome
- Deliver the requested outcome for: [SPRINT 13] CI/CD Pipeline — GitHub Actions for test, lint, deploy.
...
Likely files: .github/, Dockerfile
