# Clanker Ops #87: [iOS-03] Google Stitch — design screens + export design tokens

Status: deferred
Owner: @dad_웃
Tags: #dad #design #ios #stitch
Branch: dad_1805
Blocked by: #29
...
- Confirm #87 is still open, assigned to you, and not blocked.
- Mark #87 in progress before implementation work.
...
### Intended Outcome
- Deliver the requested outcome for: [iOS-03] Google Stitch — design screens + export design tokens; context: #ios #design #stitch #dad.
...
## Intended Outcome
All screens designed in Stitch, tokens exported as JSON.

## Step-by-Step
1. Incorporate #29 review findings
2. Design screens in Google Stitch
3. Export color/typography/spacing tokens
4. Create interactive prototype

## Verification
Stitch project navigable, JSON tokens importable by Flutter.

## Skills/Tools Required
- `mobile-ios-design` -> `.agents/skills-archive/mobile-ios-design/SKILL.md`
- `ios-hig-design` -> `.agents/skills-archive/ios-hig-design/SKILL.md`
