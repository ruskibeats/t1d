# Clanker Ops #90: [iOS-06] Device testing — provisioning + real iPhone test

Status: pending
Owner: @tom_웃
Tags: #device #ios #testing #tom
Branch: dad_1805
Blocked by: #85, #89
...
- Confirm #90 is still open, assigned to you, and not blocked.
- Mark #90 in progress before implementation work.
...
### Intended Outcome
- Deliver the requested outcome for: [iOS-06] Device testing — provisioning + real iPhone test; context: #ios #testing #device #tom.
...
After iOS-01 (certs) + iOS-05 (build). Add physical iPhone UDID to Apple Developer portal. Regenerate development provisioning profile with device included. Run `flutter run --release` on connected iPhone. Test all features: navigation gestures, animations, push notifications, performance, memory. File any issues as new bugs for @dad_웃.
