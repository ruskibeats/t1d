# Clanker Ops #94: [OPS] Fix Pi agent on Windows — tom's Pi.Dev clanker setup
...
- Confirm #94 is still open, assigned to you, and not blocked.
- Mark #94 in progress before implementation work.
